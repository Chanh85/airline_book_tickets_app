                    ...
                    child: LayoutBuilder(
                            builder: (BuildContext context, BoxConstraints constraints ) {
                              return Flex(
                                ...
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                mainAxisSize: MainAxisSize.max,
                                children: List.generate((constraints.constrainWidth()/17).floor(), (index) => const SizedBox(
                                  width: 5, height: 1, child: DecoratedBox(decoration: BoxDecoration(color: Colors.white),),
                                )),
                              );
                            },
                          ),
